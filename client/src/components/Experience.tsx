...
const experiences = [
  ...
  { 
    ...
    description: "Full Stack .NET, C# Development. Led the design and development of critical backend services and cloud infrastructure. Optimized database performance and ensured system reliability across distributed environments."
  },
  {
